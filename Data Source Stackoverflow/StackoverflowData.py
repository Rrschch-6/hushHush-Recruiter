...
data_stack = {'UserName': display_name, 'UserID': user_id, 'Reputation': reputation,
              'Top-Tag: Tag with highest answer score': tag_name, 'Top-Tag Score': top_tag_score,
              'ScoreReputation': Score_Reputation}
